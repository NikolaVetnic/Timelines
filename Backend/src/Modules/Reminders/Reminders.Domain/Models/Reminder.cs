...
public class Reminder : Aggregate<ReminderId>
{
    ...
    public static Reminder Create(ReminderId id, string title, string description, DateTime notifyAt, int priority, string colorHex, string ownerId, NodeId nodeId)
    {
    ...
    public void Update(string title, string description, DateTime notifyAt, int priority, string colorHex, string ownerId)
    {
        Title = title;
        Description = description;
        NotifyAt = notifyAt;
