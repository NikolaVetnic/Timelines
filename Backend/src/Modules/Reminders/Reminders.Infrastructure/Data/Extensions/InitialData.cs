    ...
    public static IEnumerable<Reminder> Reminders =>
        new List<Reminder>
        {
            Reminder.Create(
                ...
                "Meeting Room 1 - Daily", "Important meeting with Timo", DateTime.Now.AddHours(2), "High", DateTime.Now.AddHours(1), "Pending"),

            Reminder.Create(
                ReminderId.Of(Guid.Parse("6968d886-9e39-4fc0-9f2c-a5fbc1548970")),
                "Weekly Team Sync", "Basic team sync with the team", DateTime.Now.AddHours(2), "Low", DateTime.Now.AddHours(1), "Canceled"),
        };
}
