...
internal class UpdateReminderHandler(IRemindersRepository remindersRepository, INodesService nodesService) : ICommandHandler<UpdateReminderCommand, UpdateReminderResult>
{
