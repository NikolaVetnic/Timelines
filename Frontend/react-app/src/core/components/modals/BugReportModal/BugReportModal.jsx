...
const BugReportModal = ({ isOpen, onClose }) => {
  ...
  const validateForm = () => {
    ...
    if (!bugReport.description.trim()) newErrors.description = "Description is required";
    if (!bugReport.reporterName.trim()) newErrors.reporterName = "Your name is required";
