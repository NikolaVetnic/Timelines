  ...
  import { InfiniteScrollWrapper } from "../core/components/infinite-scroll-wrapper/InfintiteScrollWrapper";
  ...
  const HomePage = () => {
    ...
    const fetchMoreTimelines = async (page) => {
      try {
        const response = await TimelineService.getAllTimelines(page - 1, itemsPerPage);
        return {
          items: response.items,
          total: response.total
        };
      } catch (error) {
        console.error("Error fetching more timelines:", error);
        throw error;
      }
    };
      ...
      <div className="timeline-list-container">
        ...
        {isMobile ? (
          <InfiniteScrollWrapper
            ...
            loader={<div className="loading-more">Loading more timelines...</div>}
            endMessage={
              <div className="end-message">No more timelines to load</div>
            }
          />
        ) : (
          <>
